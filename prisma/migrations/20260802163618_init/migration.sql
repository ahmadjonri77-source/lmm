-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'SUPERADMIN', 'TEACHER', 'ASISTENT', 'STUDENT');

-- CreateEnum
CREATE TYPE "CourseLevel" AS ENUM ('BEGINNER', 'ELEMENTERIY', 'PREINTERMEDIA', 'INTERMEDIATE', 'ADVANCED');
...
-- AddForeignKey
ALTER TABLE "material_files" ADD CONSTRAINT "material_files_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "materials"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
